package tw.edu.pu.gm.s1091815.twod
...
import tw.edu.pu.gm.s1091815.twod.databinding.ActivityMainBinding
            ...
            override fun onClick(p0: View?) {
                ...
                job = GlobalScope.launch(Dispatchers.Main) {
                    while(secondsLeft > 0) {
                        ...
                        val canvas: Canvas = binding.mysv.surfaceHolder.lockCanvas()
